...
var Cube = {
   ...
   Triangles : [    // Also in groups of threes to define the points of each triangle
   ...
   Texture : [  // This array is in groups of two, x and y coordinates (aka U,V) in the texture
